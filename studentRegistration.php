...
<body>
    <div class="container">
        <?php
            if($connectionState){
                echo ("<div style='background-color:green;height:40px;position: absolute;'><h5 style='color:white;text-align: center;'>&nbsp;&nbsp;Conndection Sucessful&nbsp;&nbsp;</h5></div>");
            }else{
                echo ("<div style='background-color:red;height:40px;position: absolute;'><h5 style='color:white;text-align: center;'>&nbsp;&nbsp;Conndection Faild&nbsp;&nbsp;</h5></div>");
            }
        ?>
        <div class="row">
        <div class="col-lg-4" style=""></div>
    <div class="col-lg-4" style="padding: 16px;margin-top: 30px;height: 1500px;">
